...
public class availability extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv = findViewById(R.id.Ta);
        spin = findViewById(R.id.spinercult);
        vv = findViewById(R.id.vidpr);
    ...
    // en la cuestion de los clickable spans, tal vez valga la pena , primero hacer un string con la explicacion de cada plabra
    // y hacer tambien los clickable spans con nombres de la palabra, hacer copy paste al codigo y solo pasar la variable de
    // string
    // si parece qeu van a haber un putazo de clickablespans y una clase llena de dfiniciones, no se como solo dar copy
    // paste para que sean los mismos y no tener que buscar indexes de cada lectura por separado , hay que ver la forma
    // de solo dar copy paste para hacer el jale una sola vez
