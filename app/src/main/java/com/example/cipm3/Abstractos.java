...
public class Abstractos {
    ...
    String vn1[] = {"conozco ", "aprendo ", "entiendo ", "considero ", "mantengo ", "explico ", "enfatizo "};
    String vn2[] = {"conoces ", "aprendes ", "entiendes ", "consideras ", "mantienes ", "explicas ", "enfatizas "};
    String vnb3[] = {"conoce ", "aprende ", "entiende ", "considera ", "mantiene ", "explica ", "enfatiza "};
    String vn4[] = {"conocen ", "aprenden ", "entienden ", "consideran ", "mantienen ", "explican ", "enfatizan "};
    String vn5[] = {"conocemos ", "aprendemos ", "entendemos ", "consideramos ", "mantenemos ", "explicamos ", "enfatizamos "};

    String vnbcs[] = {"conociendo ", "aprendiendo ", "entendiendo ", "considerando ", "manteniendo ", "explicando ", "enfatizando "};
    String vnbc[] = {"knowing ", "learning ", "understanding ", "considering ", "maintaining ", "explaining ", "emphasizing "};

    // verbos participio esp
    String vpsp[] = {"conocido ", "aprendido ", "entendido ", "considerado ", "mantenido ", "explicado ", "enfatizado "};
    String vpspM[] = {"conocido ", "aprendido ", "entendido ", "considerado ", "mantenido ", "explicado ", "enfatizado "};
    String vpspF[] = {"aprendida ", "entendida ", "considerada ", "mantenida ", "explicada ", "enfatizada "};

    String vpeng[] = {"known ", "learned ", "understood ", "considered ", "maintained ", "explained ", "emphasized "};
    String vpengM[] = {"known ", "learned ", "understood ", "considered ", "maintained ", "explained ", "emphasized "};
    String vpengF[] = {"known ", "learned ", "understood ", "considered ", "maintained ", "explained ", "emphasized "};


    //verbos base en pasado
    String vnbp[] = {"knew ", "learned ", "understood ", "considered ", "maintained ", "explained ", "emphasized "};
    String vnbpM[] = {"knew ", "learned ", "understood ", "considered ", "maintained ", "explained ", "emphasized "};
    String vnbpF[] = {"knew ",  "learned ", "understood ", "considered ", "maintained ", "explained ", "emphasized "};
...
//these should go right after the subject
    ...
    public void intporprepps0a100(){
        ...
        switch (neg) {
            case 0:
                ps1 = prep.absspecial[p][p2] + vn1[v] + nnoblesesp[n] ;
                ps1eng = "I " + vnb[v] + nnobles[n] +prep.absspecialeng[p][p2]  ;

                ps2 =prep.absspecial[p][p2] +vn2[v] + nnoblesesp[n];
                ps2eng = "you " + vnb[v] + nnobles[n]+prep.absspecialeng[p][p2];

                ps3 =prep.absspecial[p][p2] + vn3[v] + nnoblesesp[n];
                ps3eng = "he " + vnb3[v] + nnobles[n]+prep.absspecialeng[p][p2];

                ps3ella = prep.absspecial[p][p2] + vn3[v] + nnoblesesp[n];
                ps3she = "she " + vnb3[v] + nnobles[n]+prep.absspecialeng[p][p2];

                ps3eso = prep.absspecial[p][p2] +vn3[v] + nnoblesesp[n];
                ps3it = "it " + vnb3[v] + nnobles[n]+prep.absspecialeng[p][p2];

                ps4 = prep.absspecial[p][p2] +vn4[v] + nnoblesesp[n];
                ps4eng = "they " + vnb[v] + nnobles[n]+prep.absspecialeng[p][p2];

                ps5 =  prep.absspecial[p][p2] +vn5[v] + nnoblesesp[n];
                ps5eng = "we " + vnb[v] + nnobles[n]+prep.absspecialeng[p][p2];
                break;
            case 1 :
                ps1 = prep.absspecial[p][p2] + "no "+ vn1[v] + nnoblesesp[n];
                ps1eng = "I " + "don't "+ vnb[v] + nnobles[n]+prep.absspecialeng[p][p2];

                ps2 = prep.absspecial[p][p2] +"no "+vn2[v] + nnoblesesp[n];
                ps2eng = "you " +   "don't "+ vnb[v] + nnobles[n]+prep.absspecialeng[p][p2];

                ps3 = prep.absspecial[p][p2] +  "no "+   vn3[v] + nnoblesesp[n];
                ps3eng = "he " +  "doesn't "+ vnb[v] + nnobles[n]+prep.absspecialeng[p][p2];

                ps3ella =  prep.absspecial[p][p2] + "no "+ vn3[v] + nnoblesesp[n];
                ps3she = "she " + "doesn't " + vnb[v] + nnobles[n]+prep.absspecialeng[p][p2];

                ps3eso = prep.absspecial[p][p2] + "no "+ vn3[v] + nnoblesesp[n];
                ps3it = "it " + "doesn't "+ vnb[v] + nnobles[n]+prep.absspecialeng[p][p2];

                ps4 =prep.absspecial[p][p2] +  "no "+ vn4[v] + nnoblesesp[n];
                ps4eng = "they " + "don't " +vnb[v] + nnobles[n]+prep.absspecialeng[p][p2];

                ps5 = prep.absspecial[p][p2] +  "no "+  vn5[v] + nnoblesesp[n];
                ps5eng = "we " + "don't "+ vnb[v] + nnobles[n]+prep.absspecialeng[p][p2];
                break;
    ...
    public void intporpasiva0a100(){
        int p= (int)(Math.random()*prep.absspecialeng.length );
        int p2=(int)(Math.random()*prep.absspecialeng[p].length);
        switch (neg) {
            case 0:

                ps3 = "se " + vnb3[v] + nnoblesesp[n]+ prep.absspecial[p][p2];
                ps3eng = "he " + vn3[v] + nnobles[n]+ prep.absspecialeng[p][p2];
                ps3she = "she " + vn3[v] + nnobles[n]+ prep.absspecialeng[p][p2];
                ps3it = "it " + vn3[v] + nnobles[n]+ prep.absspecialeng[p][p2];
                ps4eng = "they " + vnb[v] + nnobles[n]+ prep.absspecialeng[p][p2];
                ps1eng= "one " + vn3[v] + nnobles[n]+ prep.absspecialeng[p][p2];
                ps5eng="we " + vnb[v] + nnobles[n]+ prep.absspecialeng[p][p2];
            ...
            case 1 :
                ...
                ps3 = "no se " + vnb3[v] + nnoblesesp[n]+ prep.absspecial[p][p2];
                ps3eng = "he doesn´t " + vnb[v] + nnobles[n]+ prep.absspecialeng[p][p2];
                ps3she = "she doesn´t " + vnb[v] + nnobles[n]+ prep.absspecialeng[p][p2];
                ps3it = "it doesn´t " + vnb[v] + nnobles[n]+ prep.absspecialeng[p][p2];
                ps4eng = "they don´t " + vnb[v] + nnobles[n]+ prep.absspecialeng[p][p2];
                ps1eng= "one doesn´t " + vnb[v] + nnobles[n]+ prep.absspecialeng[p][p2];
                ps5eng="we don´t " + vnb[v] + nnobles[n]+ prep.absspecialeng[p][p2];
                break;
