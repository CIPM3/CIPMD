...
public class Oo3 {
    ...
    String vn1[] = {"hago ", "guardo ", "levanto ", "golpeo ", "disparo ", "muevo ",
            "compro ", "muestro ", "busco ", "quito ", "vendo ", "reservo ",
            "rompo ", "cubro "
    };
    String vn2[] = {"haces ", "guardas ", "levantas ", "golpeas ", "disparas ", "mueves ",
    ...
    String vn4[] = {"hacen ", "guardan ", "levantan ", "golpean ", "disparan ", "mueven ",
    ...
    String ps1pre[] = {"hice ", "guardé ", "levanté ", "golpeé ", "disparé ",
            "moví ", "compré ", "mostré ", "busqué ", "quité ", "vendí ",
            "reservé ", "rompí ", "cubrí "
    };
    String ps1imp[] = {"hacía ", "guardaba ", "levantaba ", "golpeaba ",
            "disparaba ", "movía ", "compraba ", "mostraba ", "buscaba ",
            "quitaba ", "vendía ", "reservaba ", "rompía ", "cubría "
    };

    String ps2pre[] = {"hiciste ", "guardaste ", "levantaste ", "golpeaste ",
            "disparaste ", "moviste ", "compraste ", "mostraste ", "buscaste ",
            "quitaste ", "vendiste ", "reservaste ", "rompiste ", "cubriste "
    };
    String ps2imp[] = {"hacías ", "guardabas ", "levantabas ", "golpeabas ",
            "disparabas ", "movías ", "comprabas ", "mostrabas ", "buscabas ",
            "quitabas ", "vendías ", "reservabas ", "rompías ", "cubrías "
    };

    String ps3p[] = {"hizo ", "guardó ", "levantó ", "golpeó ", "disparó ",
            "movió ", "compró ", "mostró ", "buscó ", "quitó ", "vendió ",
            "reservó ", "rompió ", "cubrió "
    };
    String ps3imp[] = {"hacía ", "guardaba ", "levantaba ", "golpeaba ",
            "disparaba ", "movía ", "compraba ", "mostraba ", "buscaba ",
            "quitaba ", "vendía ", "reservaba ", "rompía ", "cubría "
    };

    String vn4p[] = {"hicieron ", "guardaron ", "levantaron ", "golpearon ",
            "dispararon ", "movieron ", "compraron ", "mostraron ", "buscaron ",
            "quitaron ", "vendieron ", "reservaron ", "rompieron ", "cubrieron "
    };
    String vn4imp[] = {"hacían ", "guardaban ", "levantaban ", "golpeaban ",
            "disparaban ", "movían ", "compraban ", "mostraban ", "buscaban ",
            "quitaban ", "vendían ", "reservaban ", "rompían ", "cubrían "
    };

    String vn5p[] = {"hicimos ", "guardamos ", "levantamos ", "golpeamos ",
            "disparamos ", "movimos ", "compramos ", "mostramos ", "buscamos ",
            "quitamos ", "vendimos ", "reservamos ", "rompimos ", "cubrimos "
    };
    String vn5imp[] = {"hacíamos ", "guardábamos ", "levantábamos ", "golpeábamos ",
            "disparábamos ", "movíamos ", "comprábamos ", "mostrábamos ", "buscábamos ",
            "quitábamos ", "vendíamos ", "reservábamos ", "rompíamos ", "cubríamos "
    };

    String vn1f[] = {"haré ", "guardaré ", "levantaré ", "golpearé ", "dispararé ",
            "moveré ", "compraré ", "mostraré ", "buscaré ", "quitaré ", "venderé ",
            "reservaré ", "romperé ", "cubriré "
    };
    String vn2f[] = {"harás ", "guardarás ", "levantarás ", "golpearás ", "dispararás ",
            "moverás ", "comprarás ", "mostrarás ", "buscarás ", "quitarás ", "venderás ",
            "reservarás ", "romperás ", "cubrirás "
    };
    String vnbf[] = {"hará ", "guardará ", "levantará ", "golpeará ", "disparará ",
            "moverá ", "comprará ", "mostrará ", "buscará ", "quitará ", "venderá ",
            "reservará ", "romperá ", "cubrirá "
    };
    String vn4f[] = {"harán ", "guardarán ", "levantarán ", "golpearán ", "dispararán ",
            "moverán ", "comprarán ", "mostrarán ", "buscarán ", "quitarán ", "venderán ",
            "reservarán ", "romperán ", "cubrirán "
    };
    String vn5f[] = {"haremos ", "guardaremos ", "levantaremos ", "golpearemos ",
            "dispararemos ", "moveremos ", "compraremos ", "mostraremos ", " buscaremos",
            "quitaremos ", "venderemos ", "reservaremos ", "romperemos ", "cubriremos "
    };

    String vn1w[] = {"haría ", "guardaría ", "levantaría ", "golpearía ", "dispararía ",
            "movería ", "compraría ", "mostraría ", "buscaría ", "quitaría ", "vendería ",
            "reservaría ", "rompería ", "cubriría "
    };
    String vn2w[] = {"harías ", "guardarías ", "levantarías ", "golpearías ", "dispararías ",
            "moverías ", "comprarías ", "mostrarías ", "buscarías ", "quitarías ", "venderías ",
            "reservarías ", "romperías ", "cubrirías "
    };
    String vnbw[] = {"haría ", "guardaría ", "levantaría ", "golpearía ", "dispararía ",
            "movería ", "compraría ", "mostraría ", "buscaría ", "quitaría ", "vendería ",
            "reservaría ", "rompería ", "cubriría "
    };
    String vn4w[] = {"harían ", "guardarían ", "levantarían ", "golpearían ", "dispararían ",
            "moverían ", "comprarían ", "mostrarían ", "buscarían ", "quitarían ", "venderían ",
            "reservarían ", "romperían ", "cubrirían "
    };
    String vn5w[] = {"haríamos ", "guardaríamos ", "levantaríamos ", "golpearíamos ", "dispararíamos ",
            "moveríamos ", "compraríamos ", "mostraríamos ", "buscaríamos ", "quitaríamos ",
            "venderíamos ", "reservaríamos ", "romperíamos ", "cubriríamos "
    };

    String vn1y3subj[] = {"haga ", "guarde ", "levante ", "golpee ", "dispare ",
            "mueva ", "compre ", "muestre ", "busque ", "quite ", "venda ",
            "reserve ", "rompa ", "cubra "
    };
    String vn2subj[] = {"hagas ", "guardes ", "levantes ", "golpees ", "dispares ",
            "muevas ", "compres ", "muestres ", "busques ", "quites ",
            "vendas ", "reserves ", "rompas ", "cubras "
    };
    String vn4subj[] = {"hagan ", "guarden ", "levanten ", "golpeen ", "disparen ",
            "muevan ", "compren ", "muestren ", "busquen ", "quiten ", "vendan ",
            "reserven ", "rompan ", "cubran "
    };
    String vn5subj[] = {"hagamos ", "guardemos ", "levantemos ", "golpeemos ",
            "disparemos ", "movamos ", "compremos ", "mostremos ", "busquemos ",
            "quitemos ", "vendamos ", "reservemos ", "rompamos ", "cubramos "
    };

    //pasados (agregado wish SV 060422)
    String ps1wish[] = {"hiciera ", "guardara ", "levantara ", "golpeara ", "disparara ",
            "moviera ", "comprara ", "mostrara ", "buscara ", "quitara ", "vendiera ",
            "reservara ", "rompiera ", "cubriera "
    };
    String ps2wish[] = {"hicieras ", "guardaras ", "levantaras ", "golpearas ",
            "dispararas ", "movieras ", "compraras ", "mostraras ", "buscaras ",
            "quitaras ", "vendieras ", "reservaras ", "rompieras ", "cubrieras "
    };
    String ps3wish[] = {"hiciera ", "guardara ", "levantara ", "golpeara ",
            "disparara ", "moviera ", "comprara ", "mostrara ", "buscara ",
            "quitara ", "vendiera ", "reservara ", "rompiera ", "cubriera "
    };
    String ps4wish[] = {"hicieran ", "guardaran ", "levantaran ", "golpearan ",
            "dispararan ", "movieran ", "compraran ", "mostraran ", "buscaran ",
            "quitaran ", "vendieran ", "reservaran ", "rompieran ", "cubrieran "
    };
    String ps5wish[] = {"hiciéramos ", "guardáramos ", "levantáramos ", "golpeáramos ",
            "disparáramos ", "moviéramos ", "compráramos ", "mostráramos ", "buscáramos ",
            "quitáramos ", "vendiéramos ", "reserváramos ", "rompiéramos ", "cubriéramos "
    };

    String nnobles[] = {
            "the studio ", "the topic ", "the ad ", "the agency ",
            "the college ",
            "the collection ", "the alcohol ", "the contract ",
            "the highway ",
            "the elevator ", "the bread ", "the construction ",
            "the steak ",
            "the region ", "the seat ", "the classroom ",
            "the virus ", "the union "
    };
    String nnoblesesp[] = {
            "el estudio ", "el tema ", "el anuncio ", "la agencia ",
            "el colegio ",
            "la colección ", "el alcohol ", "el contrato ",
            "la carretera ",
            "el ascensor ", "el pan ", "la construcción ", "el filete ",
            "la región ", "el asiento ", "el aula ", "el virus ",
            "la unión "
    };
    ...
    public void GenFutSimp2() {
        switch (neg) {
            case 0:
                ...
                ps3 = "él " + vnbf[v] + nnoblesesp[n];
                ps3eng = "he " + "will " + vnb[v] + nnobles[n];

                ps3ella = "ella " + vnbf[v] + nnoblesesp[n];
                ps3she = "she " + "will " + vnb[v] + nnobles[n];

                ps3eso = "eso " + vnbf[v] + nnoblesesp[n];
    ...
    public void GenWouldSimp2() {
        switch (neg) {
            case 0:
                ...
                ps3 = "él " + vnbw[v] + nnoblesesp[n];
                ps3eng = "he " + "would " + vnb[v] + nnobles[n];

                ps3ella = "ella " + vnbw[v] + nnoblesesp[n];
                ps3she = "she " + "would " + vnb[v] + nnobles[n];

                ps3eso = "eso " + vnbw[v] + nnoblesesp[n];
...
//these should go right after the subject
    ...
    public void PasiveCause2() {
        ...
        switch (neg) {
            // yo + hago que + un metodo sea creado por un metodo
            //Masculino Positivo
            case 0:
    ...
    public void supposedtopast() {
        ...
        switch (neg) {
            case 0:
                ...
                ps3it = "it was supposed to " + vnb[v] + nnobles[n];
    ...
    public void supposedtopast3() {
        ...
        switch (neg) {
            case 0:
                ...
                ps3it = "it was supposed to " + vnb[v] + nnobles[n] + frequadv[radv];
    ...
    public void GenFutSimp4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps3 = "él " + vnbf[v] + nnoblesesp[n] + prep.noblesspecial[p][p2] + advfrequ[r];
                ...
                ps3ella = "ella " + vnbf[v] + nnoblesesp[n] + prep.noblesspecial[p][p2] + advfrequ[r];
                ...
                ps3eso = "eso " + vnbf[v] + nnoblesesp[n] + prep.noblesspecial[p][p2] + advfrequ[r];
            ...
            case 1:
                ...
                ps3 = "él " + "no " + vnbf[v] + nnoblesesp[n] + prep.noblesspecial[p][p2] + advfrequ[r];
                ...
                ps3ella = "ella " + "no " + vnbf[v] + nnoblesesp[n] + prep.noblesspecial[p][p2] + advfrequ[r];
                ...
                ps3eso = "eso " + "no " + vnbf[v] + nnoblesesp[n] + prep.noblesspecial[p][p2] + advfrequ[r];
    ...
    public void GenWouldSimp4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps3 = "él "  + vnbw[v] + nnoblesesp[n]+ prep.noblesspecial[p][p2] + advfrequ[radv];
                ...
                ps3ella = "ella "  + vnbw[v] + nnoblesesp[n]+ prep.noblesspecial[p][p2] + advfrequ[radv];
                ...
                ps3eso = "eso "  + vnbw[v] + nnoblesesp[n]+ prep.noblesspecial[p][p2] + advfrequ[radv];
            ...
            case 1:
                ...
                ps3 = "él " + "no " + vnbw[v] + nnoblesesp[n] + prep.noblesspecial[p][p2] ;
                ...
                ps3ella = "ella " + "no " + vnbw[v] + nnoblesesp[n] + prep.noblesspecial[p][p2] ;
                ...
                ps3eso = "eso " + "no " + vnbw[v] + nnoblesesp[n] + prep.noblesspecial[p][p2] ;
    ...
    public void supposedtopast4() {
        ...
        switch (neg) {
            case 0:
                ...
                ps3she = "she was supposed to " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                ps3eso = "Se supone que eso " + ps3imp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3it = "it was supposed to " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
    ...
    public void intporsujetops0a100(){
        ...
        switch (neg) {
            case 0:
                ...
                ps3 = vnb3[v] + nnoblesesp[n];
                ps3eng = "he " + vnb3[v] + nnobles[n];

                ps3ella = vnb3[v] + nnoblesesp[n];
                ps3she = "she " + vnb3[v] + nnobles[n];

                ps3eso = vnb3[v] + nnoblesesp[n];
    ...
    public void intporprepps0a100(){
        ...
        switch (neg) {
            case 0:
                ps1 = prep.Oospecial[p][p2] + vn1[v] + nnoblesesp[n] ;
                ps1eng = "I " + vnb[v] + nnobles[n] +prep.Oospecialeng[p][p2]  ;

                ps2 =prep.Oospecial[p][p2] +vn2[v] + nnoblesesp[n];
                ps2eng = "you " + vnb[v] + nnobles[n]+prep.Oospecialeng[p][p2];

                ps3 =prep.Oospecial[p][p2] + vnb[v] + nnoblesesp[n];
                ps3eng = "he " + vnb3[v] + nnobles[n]+prep.Oospecialeng[p][p2];

                ps3ella = prep.Oospecial[p][p2] + vnb[v] + nnoblesesp[n];
                ps3she = "she " + vnb3[v] + nnobles[n]+prep.Oospecialeng[p][p2];

                ps3eso = prep.Oospecial[p][p2] +vnb[v] + nnoblesesp[n];
                ps3it = "it " + vnb3[v] + nnobles[n]+prep.Oospecialeng[p][p2];

                ps4 = prep.Oospecial[p][p2] +vn4[v] + nnoblesesp[n];
                ps4eng = "they " + vnb[v] + nnobles[n]+prep.Oospecialeng[p][p2];

                ps5 =  prep.Oospecial[p][p2] +vn5[v] + nnoblesesp[n];
                ps5eng = "we " + vnb[v] + nnobles[n]+prep.Oospecialeng[p][p2];
                break;
            case 1 :
                ps1 = prep.Oospecial[p][p2] + "no "+ vn1[v] + nnoblesesp[n];
                ...
                ps3 = prep.Oospecial[p][p2] +  "no "+   vnb[v] + nnoblesesp[n];
                ps3eng = "he " +  "doesn't "+ vnb[v] + nnobles[n]+prep.Oospecialeng[p][p2];

                ps3ella =  prep.Oospecial[p][p2] + "no "+ vnb[v] + nnoblesesp[n];
                ps3she = "she " + "doesn't " + vnb[v] + nnobles[n]+prep.Oospecialeng[p][p2];

                ps3eso = prep.Oospecial[p][p2] + "no "+ vnb[v] + nnoblesesp[n];
    ...
    public void intreflps0a100(){
        ...
        switch (control){
            ...
            case 2:
                ...
                ps3 = "él se " + vnb[v] + " a si mismo " ;
                ps3eng = "he " + vnb3[v] + " himself";

                ps3ella = "ella se " + vnb[v]+ " a si misma ";
                ps3she = "she " + vnb3[v] + " herself";

                ps3eso = "eso se " + vnb[v] + " a si mismo ";
            ...
            case 5:
                ...
                ps3 = "él no se " + vnb[v] + " a si mismo " ;
                ps3eng = "he doesn´t " + vnb3[v] + " himself";

                ps3ella = "ella no se " + vnb[v]+ " a si misma ";
                ps3she = "she doesn´t " + vnb3[v] + " herself";

                ps3eso = "eso no se " + vnb[v] + " a si mismo ";
    ...
    }    // por reflexivo, incluye pronominal y get , reflx normales- adapted
    public void intporpasiva0a100(){
        int p= (int)(Math.random()*prep.Oospecialeng.length );
        int p2=(int)(Math.random()*prep.Oospecial[p].length);
        switch (neg) {
            case 0:

                ps3 = "se " + vnb3[v] + nnoblesesp[n]+ prep.Oospecial[p][p2];
                ps3eng = "he " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2];
                ps3she = "she " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2];
                ps3it = "it " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2];
                ps4eng = "they " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2];
                ps1eng= "one " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2];
                ps5eng="we " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2];
            ...
            case 1 :
                ...
                ps3 = "no se " + vnb3[v] + nnoblesesp[n]+ prep.Oospecial[p][p2];
                ps3eng = "he doesn´t " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2];
                ps3she = "she doesn´t " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2];
                ps3it = "it doesn´t " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2];
                ps4eng = "they don´t " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2];
                ps1eng= "one doesn´t " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2];
                ps5eng="we don´t " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2];
                break;
