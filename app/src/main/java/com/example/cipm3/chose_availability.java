...
public class chose_availability extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_chose_availability);
    }

    public void aval_old(View vista) {
        Intent intento = new Intent(this, availability.class);
        startActivity(intento);
    }

    public void aval_new(View vista) {
