...
public class Pasts {
    ...
    String vtis[] = {"tener ", "hacer ", "decir ", "obtener ", "hacer (make) ", "saber ", "tomar ", "ver ",
            ...
            "conocer ", "incluir ", "continuar ", "establecer ", "aprender ", "cambiar ", "dirigir ", "observar ",
            "seguir ", "detener ", "crear ", "hablar ", "leer ", "agregar ", "gastar ", "abrir ", "ganar ",
            "ofrecer ", "recordar ", "amar ", "considerar ", "comprar ", "servir ", "enviar ", "esperar (expectativa) ",
    ...
    String vtbpast[] = {"had ", "did ", "said ", "got ", "made ", "knew ", "took ", "saw ",
            ...
            "met ", "included ", "continued ", "set ", "learnt ", "changed ", "led ", "watched ",
            "followed ", "stopped ", "created ", "spoke ", "read ", "added ", "spent ", "opened ", "won ",
            "offered ", "remembered ", "loved ", "considered ", "bought ", "served ", "sent ", "expected ",
            "built ", "cut ", "killed "
    };
    ...
    String vtbp1[] = {"tenía ", "hacia ", "decía ", "obtenía ", "hacia ", "sabía ", "tomaba ", "veía ",
            ...
            "jugaba ", "me movía ", "creía ", "sostenía ", "traía ", "escribía ", "proveía ", "perdia ", "pagaba ",
            "conocía ", "incluía ", "continuaba ", "ajustaba ", "aprendía ", "cambiaba ", "dirigía ", "observaba ",
            "seguía ", "detenía ", "creaba ", "hablaba ", "leía ", "agregaba ", "gastaba ", "abría ", "ganaba ",
            "ofrecía ", "recordaba ", "amaba ", "consideraba ", "compraba ", "servía ", "enviaba ", "esperaba ",
    ...
    String vtbp1pr[] = {"tuve ", "hice ", "dije ", "obtuve ", "hice ", "supe ", "tomé ", "ví ",
            ...
            "jugué ", "me moví ", "creí ", "sostuve ", "traje ", "escribí ", "proveí ", "perdí ", "pagué ",
            "conocí ", "incluí ", "continué ", "ajusté ", "aprendí ", "caminé ", "dirigí ", "observé ",
            "seguí ", "detuve ", "creé ", "hablé ", "leí ", "agregué ", "gasté ", "abrí ", "gané ",
            "ofrecí ", "recordé ", "amé ", "consideré ", "compré ", "serví ", "envié ", "esperé ",
            "construí ", "corté ", "maté "
    };
    ...
    String vtbp2[] = {"tenías ", "hacias ", "decías ", "obtenías ", "hacias ", "sabías ", "tomabas ", "veías ",
            ...
            "jugabas ", "te movías ", "creías ", "sostenías ", "traías ", "escribías ", "proveías ", "perdias ", "pagabas ",
            "conocías ", "incluías ", "continuabas ", "ajustabas ", "aprendías ", "cambiabas ", "dirigías ", "observabas ",
            "seguías ", "detenías ", "creabas ", "hablabas ", "leías ", "agregabas ", "gastabas ", "abrías ", "ganabas ",
            "ofrecías ", "recordabas ", "amabas ", "considerabas ", "comprabas ", "servías ", "enviabas ", "esperabas ",
            "construías ", "cortabas ", "matabas "
    };
    ...
    String vtbp2pr[] = {"tuviste ", "hiciste ", "dijiste ", "obtuviste ", "hiciste ", "supiste ", "tomaste ", "víste ",
            ...
            "jugaste ", "te movíste ", "creíste ", "sostuviste ", "trajiste ", "escribíste ", "proveíste ", "perdíste ", "pagaste ",
            "conocíste ", "incluíste ", "continuaste ", "ajustaste ", "aprendiste ", "caminaste ", "dirigiste ", "observaste ",
            "seguiste ", "detuviste ", "creaste ", "hablaste ", "leiste ", "agregaste ", "gastaste ", "abriste ", "ganaste ",
            "ofreciste ", "recordaste ", "amaste ", "consideraste ", "compraste ", "serviste ", "enviaste ", "esperaste ",
            "construiste ", "cortaste ", "mataste "
    };
    ...
    String vtbp3[] = {"tenía ", "hacia ", "decía ", "obtenía ", "hacia ", "sabía ", "tomaba ", "veía ",
            ...
            "sentía ",
            "dejaba ", "ponía ", "mantenía ", "comenzaba ", "ayudaba ", "volteaba ", "empezaba ", "mostraba ", "oía ",
            "jugaba ", "se movía ", "creía ", "sostenía ", "traía ", "escribía ", "proveía ", "perdia ", "pagaba ",
            "conocía ", "incluía ", "continuaba ", "ajustaba ", "aprendía ", "cambiaba ", "dirigía ", "observaba ",
            "seguía ", "detenía ", "creaba ", "hablaba ", "leía ", "agregaba ", "gastaba ", "abría ", "ganaba ",
            "ofrecía ", "recordaba ", "amaba ", "consideraba ", "compraba ", "servía ", "enviaba ", "esperaba ",
            "construía ", "cortaba ", "mataba "
    ...
    String vtbp3pr[] = {"tuvo ", "hizo ", "dijo ", "obtuvo ", "hizo ", "supo ", "tomó ", "vío ",
            ...
            "jugó ", "se movió ", "creyó ", "sostuvo ", "trajó ", "escribió ", "proveyó ", "perdió ", "pagó ",
            "conoció ", "incluyó ", "continuó ", "ajustó ", "aprendió ", "caminó ", "dirigió ", "observó ",
            "siguió ", "detuvo ", "creó ", "habló ", "leyó ", "agregó ", "gastó ", "abrió ", "ganó ",
            "ofreció ", "recordó ", "amó ", "consideró ", "compró ", "sirvió ", "envió ", "esperó ",
            "construyó ", "cortó ", "mató "
    };
    ...
    String vtbp4[] = {"tenían ", "hacian ", "decían ", "obtenían ", "hacian ", "sabían ", "tomaban ", "veían ",
            ...
            "jugaban ", "se movían ", "creían ", "sostenían ", "traían ", "escribían ", "proveían ", "perdian ", "pagaban ",
            "conocían ", "incluían ", "continuaban ", "ajustaban ", "aprendían ", "cambiaban ", "dirigían ", "observaban ",
            "seguían ", "detenían ", "creaban ", "hablaban ", "leían ", "agregaban ", "gastaban ", "abrían ", "ganaban ",
            "ofrecían ", "recordaban ", "amaban ", "consideraban ", "compraban ", "servían ", "enviaban ", "esperaban ",
            "construían ", "cortaban ", "mataban "
    };
    ...
    String vtbp4pr[] = {"tuvieron ", "hicieron ", "dijeron ", "obtuvieron ", "hicieron ", "supieron ", "tomaron ", "vieron ",
            ...
            "jugaron ", "se movieron ", "creyeron ", "sostuvieron ", "trajeron ", "escribieron ", "proveyeron ", "perdieron ", "pagaron ",
            "conocieron ", "incluyeron ", "continuaron ", "ajustaron ", "aprendieron ", "caminaron ", "dirigieron ", "observaron ",
            "siguieron ", "detuvieron ", "crearon ", "hablaron ", "leyeron ", "agregaron ", "gastaron ", "abrieron ", "ganaron ",
            "ofrecieron ", "recordaron ", "amaron ", "consideraron ", "compraron ", "sirvieron ", "enviaron ", "esperaron ",
            "construyeron ", "cortaron ", "mataron "
    };
    ...
    String vtbp5[] = {"teníamos ", "hacíamos ", "decíamos ", "obteníamos ", "hacíamos ", "sabíamos ", "tomabamos ", "veíamos ",
            ...
            "jugabamos ", "nos movíamos ", "creíamos ", "sosteníamos ", "traíamos ", "escribíamos ", "proveíamos ", "perdiamos ", "pagabamos ",
            "conocíamos ", "incluíamos ", "continuabamos ", "ajustabamos ", "aprendíamos ", "cambiabamos ", "dirigíamos ", "observabamos ",
            "seguíamos ", "deteníamos ", "creabamos ", "hablabamos ", "leíamos ", "agregabamos ", "gastabamos ", "abríamos ", "ganabamos ",
            "ofrecíamos ", "recordabamos ", "amabamos ", "considerabamos ", "comprabamos ", "servíamos ", "enviabamos ", "esperabamos ",
            "construíamos ", "cortabamos ", "matabamos "
    };
    ...
    String vtbp5pr[] = {"tuvimos ", "hicimos ", "dijimos ", "obtuvimos ", "hicimos ", "supimos ", "tomamos ", "vimos ",
            ...
            "jugamos ", "nos movimos ", "creímos ", "sostuvimos ", "trajimos ", "escribimos ", "proveímos ", "perdímos ", "pagamos ",
            "conocimos ", "incluimos ", "continuamos ", "ajustamos ", "aprendimos ", "caminamos ", "dirigimos ", "observamos ",
            "seguimos ", "detuvimos ", "creamos ", "hablamos ", "leímos ", "agregamos ", "gastamos ", "abrimos ", "ganamos ",
            "ofrecimos ", "recordamos ", "amamos ", "consideramos ", "compramos ", "servimos ", "enviamos ", "esperamos ",
            "contruimos ", "cortamos ", "matamos "
    };
    ...
    String vibf1[] = {"iré ", "pensaré ", "vendré ", "miraré ", "trabajaré ",
            ...
            "caminaré ", "creceré ", "esperaré ", "moriré ",
            "me quedaré ", "me caeré ",
    };
    ...
    String vibf2[] = {"irás ", "pensarás ", "vendrás ", "mirarás ", "trabajarás ",
            ...
            "caminarás ", "crecerás ", "esperarás ", "morirás ",
            "te quedarás ", "te caerás ",
    };
    ...
    String vibf3[] = {"irá ", "pensará ", "vendrá ", "mirará ", "trabajará ",
            ...
            "caminará ", "crecerá ", "esperará ", "morirá ",
            "se quedará ", "se caerá ",
    };
    ...
    String vibf4[] = {"irán ", "pensarán ", "vendrán ", "mirarán ", "trabajarán ",
            ...
            "caminarán ", "crecerán ", "esperarán ", "morirán ",
            "se quedarán ", "se caerán ",
    };
    ...
    String vibf5[] = {"iremos ", "pensaremos ", "vendremos ", "miraremos ", "trabajaremos ",
            ...
            "caminaremos ", "creceremos ", "esperaremos ", "moriremos ",
            "nos quedaremos ", "nos caeremos ",
    };
    ...
    String vtbf1[] = {"tendré ", "haré ", "diré ", "obtendré ", "haré ", "sabré ", "tomaré ", "veré ",
            ...
            "jugaré ", "moveré ", "creeré ", "sostendré ", "traeré ", "escribiré ", "proveeré ", "perderé ", "pagaré ",
            "conoceré ", "incluiré ", "continuaré ", "estableceré ", "aprenderé ", "cambiaré ", "dirigiré ", "observaré ",
            "seguiré ", "detendré ", "crearé ", "hablaré ", "leeré ", "agregaré ", "gastaré ", "abriré ", "ganaré ",
            "ofreceré ", "recordaré ", "amaré ", "consideraré ", "compraré ", "serviré ", "enviaré ", "esperaré ",
            "construiré ", "cortaré ", "mataré "
    };
    ...
    String vtbf2[] = {"tendrás ", "harás ", "dirás ", "obtendrás ", "harás ", "sabrás ", "tomarás ", "verás ",
            ...
            "necesitarás ",
            "sentirás ",
            "dejarás ", "pondrás ", "mantendrás ", "empezarás ", "ayudarás ", "voltearás ", "empezarás ", "mostrarás ", "oirás ",
            "jugarás ", "moverás ", "creerás ", "sostendrás ", "traerás ", "escribirás ", "proveerás ", "perderás ", "pagarás ",
            "conocerás ", "incluirás ", "continuarás ", "establecerás ", "aprenderás ", "cambiarás ", "dirigirás ", "observarás ",
            "seguirás ", "detendrás ", "crearas ", "hablarás ", "leerás ", "agregarás ", "gastarás ", "abrirás ", "ganarás ",
            "ofrecerás ", "recordarás ", "amarás ", "considerarás ", "comprarás ", "servirás ", "enviarás ", "esperarás ",
            "construirás ", "cortarás ", "matarás "
    };
    ...
    String vtbf3[] = {"tendrá ", "hará ", "dirá ", "obtendrá ", "hará ", "sabrá ", "tomará ", "verá ",
            ...
            "necesitará ",
            "sentirá ",
            "dejará ", "pondrá ", "mantendrá ", "empezará ", "ayudará ", "volteará ", "empezará ", "mostrará ", "oirá ",
            "jugará ", "moverá ", "creerá ", "sostendrá ", "traerá ", "escribirá ", "proveerá ", "perderá ", "pagará ",
            "conocerá ", "incluirá ", "continuará ", "establecerá ", "aprenderá ", "cambiará ", "dirigirá ", "observará ",
            "seguirá ", "detendrá ", "creara ", "hablará ", "leerá ", "agregará ", "gastará ", "abrirá ", "ganará ",
            "ofrecerá ", "recordará ", "amará ", "considerará ", "comprará ", "servirá ", "enviará ", "esperará ",
            "construirá ", "cortará ", "matará "
    };
    ...
    String vtbf4[] = {"tendrán ", "harán ", "dirán ", "obtendrán ", "harán ", "sabrán ", "tomarán ", "verán ",
            ...
            "necesitarán ",
            "sentirán ",
            "dejarán ", "pondrán ", "mantendrán ", "empezarán ", "ayudarán ", "voltearán ", "empezarán ", "mostrarán ", "oirán ",
            "jugarán ", "moverán ", "creerán ", "sostendrán ", "traerán ", "escribirán ", "proveerán ", "perderán ", "pagarán ",
            "conocerán ", "incluirán ", "continuarán ", "establecerán ", "aprenderán ", "cambiarán ", "dirigirán ", "observarán ",
            "seguirán ", "detendrán ", "crearan ", "hablarán ", "leerán ", "agregarán ", "gastarán ", "abrirán ", "ganarán ",
            "ofrecerán ", "recordarán ", "amarán ", "considerarán ", "comprarán ", "servirán ", "enviarán ", "esperarán ",
    ...
    String vtbf6[] = {"tendremos ", "haremos ", "diremos ", "obtendremos ", "haremos ", "sabremos ", "tomaremos ", "veremos ",
            ...
            "jugaremos ", "moveremos ", "creeremos ", "sostendremos ", "traeremos ", "escribiremos ", "proveeremos ", "perderemos ", "pagaremos ",
            "conoceremos ", "incluiremos ", "continuaremos ", "estableceremos ", "aprenderemos ", "cambiaremos ", "dirigiremos ", "observaremos ",
            "seguiremos ", "detendremos ", "crearemos ", "hablaremos ", "leeremos ", "agregaremos ", "gastaremos ", "abriremos ", "ganaremos ",
            "ofreceremos ", "recordaremos ", "amaremos ", "consideraremos ", "compraremos ", "serviremos ", "enviaremos ", "esperaremos ",
            "construiremos ", "cortaremos ", "mataremos "
    };
    ...
    String vibw1[] = {"iría ", "pensaría ", "vendría ", "miraria ", "trabajaría ",
            ...
            "caminaría ", "crecería ", "esperaría ", "moriría ",
            "me quedaría ", "me caería ",
    };
    ...
    String vibw2[] = {"irías ", "pensarías ", "vendrías ", "mirarias ", "trabajarías ",
            ...
            "caminarías ", "crecerías ", "esperarías ", "morirías ",
            "te quedarías ", "te caerías ",
    };
    ...
    String vibw4[] = {"irían ", "pensarían ", "vendrían ", "mirarian ", "trabajarían ",
            ...
            "caminarían ", "crecerían ", "esperarían ", "morirían ",
            "se quedarían ", "se caerían ",
    };
    ...
    String vibw5[] = {"iríamos ", "pensaríamos ", "vendríamos ", "mirariamos ", "trabajaríamos ",
            ...
            "caminaríamos ", "creceríamos ", "esperaríamos ", "moriríamos ",
            "nos quedaríamos ", "nos caeríamos ",
    };
    ...
    String vtbw1y3[] = {"tendría ", "haría ", "diría ", "obtendría ", "haría ", "sabría ", "tomaría ", "vería ",
            ...
            "jugaría ", "movería ", "creería ", "sostendría ", "traería ", "escribiría ", "proveería ", "perdería ", "pagaría ",
            "conocería ", "incluiría ", "continuaría ", "establecería ", "aprendería ", "cambiaría ", "dirigiría ", "observaría ",
            "seguiría ", "detendría ", "crearía ", "hablaría ", "leería ", "agregaría ", "gastaría ", "abriría ", "ganaría ",
            "ofrecería ", "recordaría ", "amaría ", "consideraría ", "compraría ", "serviría ", "enviaría ", "esperaría ",
            "construiría ", "cortaría ", "mataría "
    };
    ...
    String vtbw2[] = {"tendrías ", "harías ", "dirías ", "obtendrías ", "harías ", "sabrías ", "tomarías ", "verías ",
            ...
            "jugarías ", "moverías ", "creerías ", "sostendrías ", "traerías ", "escribirías ", "proveerías ", "perderías ", "pagarías ",
            "conocerías ", "incluirías ", "continuarías ", "establecerías ", "aprenderías ", "cambiarías ", "dirigirías ", "observarías ",
            "seguirías ", "detendrías ", "crearías ", "hablarías ", "leerías ", "agregarías ", "gastarías ", "abrirías ", "ganarías ",
            "ofrecerías ", "recordarías ", "amarías ", "considerarías ", "comprarías ", "servirías ", "enviarías ", "esperarías ",
    ...
    String vtbw4[] = {"tendrían ", "harían ", "dirían ", "obtendrían ", "harían ", "sabrían ", "tomarían ", "verían ",
            ...
            "jugarían ", "moverían ", "creerían ", "sostendrían ", "traerían ", "escribirían ", "proveerían ", "perderían ", "pagarían ",
            "conocerían ", "incluirían ", "continuarían ", "establecerían ", "aprenderían ", "cambiarían ", "dirigirían ", "observarían ",
            "seguirían ", "detendrían ", "crearían ", "hablarían ", "leerían ", "agregarían ", "gastarían ", "abrirían ", "ganarían ",
            "ofrecerían ", "recordarían ", "amarían ", "considerarían ", "comprarían ", "servirían ", "enviarían ", "esperarían ",
            "construirían ", "cortarían ", "matarían "
    };
    ...
    String vtbw5[] = {"tendríamos ", "haríamos ", "diríamos ", "obtendríamos ", "haríamos ", "sabríamos ", "tomaríamos ", "veríamos ",
            ...
            "jugaríamos ", "moveríamos ", "creeríamos ", "sostendríamos ", "traeríamos ", "escribiríamos ", "proveeríamos ", "perderíamos ", "pagaríamos ",
            "conoceríamos ", "incluiríamos ", "continuaríamos ", "estableceríamos ", "aprenderíamos ", "cambiaríamos ", "dirigiríamos ", "observaríamos ",
            "seguiríamos ", "detendríamos ", "crearíamos ", "hablaríamos ", "leeríamos ", "agregaríamos ", "gastaríamos ", "abriríamos ", "ganaríamos ",
            "ofreceríamos ", "recordaríamos ", "amaríamos ", "consideraríamos ", "compraríamos ", "serviríamos ", "enviaríamos ", "esperaríamos ",
            "construiríamos ", "cortaríamos ", "mataríamos "
    };
    ...
    String vis2[] = {"vayas ", "pienses ", "vengas ", "mires ", "trabajes ",
            ...
            "camines ", "crezcas ", "esperes ", "mueras ",
            "te quedes ", "te caigas ",
    ...
    String vis4[] = {"vayan ", "piensen ", "vengan ", "miren ", "trabajen ",
            ...
            "caminen ", "crezcan ", "esperen ", "mueran ",
            "se queden ", "se caigan ",
    ...
    String vis5[] = {"vayamos ", "pensemos ", "vengamos ", "miremos ", "trabajemos ",
            ...
            "caminemos ", "crezcamos ", "esperemos ", "muramos ",
            "nos quedemos ", "nos caigamos ",
