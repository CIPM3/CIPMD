...
public class People3 {
    ...
    String vnbf[] = {"ayudará ", "disculpará ", "apoyará ", "verá ", "servirá ",
    ...
    String vnbw[] = {"ayudaría ", "disculparía ", "apoyaría ", "vería ", "serviría ",
            "visitaría ", "preocuparía ", "escucharía ", "afectaría ", "conocería "
    };
    ...
    public void supposedtopast4() {
        ...
        switch (neg) {
            case 0:
                ...
                ps3she = "she was supposed to " + vnb[v] + nnobles[n] + prep.peoplespecialeng[p][p2] + frequadv[radv];

                ps3eso = "Se supone que eso " + ps3imp[v] + nnoblesesp[n] + prep.peoplespecial[p][p2] + advfrequ[radv];
                ps3it = "it was supposed to " + vnb[v] + nnobles[n] + prep.peoplespecialeng[p][p2] + frequadv[radv];
    ...
    public void intporsujetops0a100(){
        ...
        switch (neg) {
            case 0:
                ...
                ps3 = vnb[v] + nnoblesesp[n];
                ps3eng = "he " + vnb3[v] + nnobles[n];

                ps3ella = vnb[v] + nnoblesesp[n];
                ps3she = "she " + vnb3[v] + nnobles[n];

                ps3eso = vnb[v] + nnoblesesp[n];
            ...
            case 1 :
                ...
                ps3 =   "no "+   vnb[v] + nnoblesesp[n];
                ps3eng = "he " +  "doesn't "+ vnb[v] + nnobles[n];

                ps3ella =   "no "+ vnb[v] + nnoblesesp[n];
                ps3she = "she " + "doesn't " + vnb[v] + nnobles[n];

                ps3eso =  "no "+ vnb[v] + nnoblesesp[n];
                ps3it = "it " + "doesn't "+ vnb[v] + nnobles[n];
    ...
    public void intporprepps0a100(){
        ...
        switch (neg) {
            case 0:
                ...
                ps3 =prep.peoplespecial[p][p2] + vnb[v] + nnoblesesp[n];
                ps3eng = "he " + vnb3[v] + nnobles[n]+prep.peoplespecialeng[p][p2];

                ps3ella = prep.peoplespecial[p][p2] + vnb[v] + nnoblesesp[n];
                ps3she = "she " + vnb3[v] + nnobles[n]+prep.peoplespecialeng[p][p2];

                ps3eso = prep.peoplespecial[p][p2] +vnb[v] + nnoblesesp[n];
            ...
            case 1 :
                ...
                ps3 = prep.peoplespecial[p][p2] +  "no "+   vnb[v] + nnoblesesp[n];
                ps3eng = "he " +  "doesn't "+ vnb[v] + nnobles[n]+prep.peoplespecialeng[p][p2];

                ps3ella =  prep.peoplespecial[p][p2] + "no "+ vnb[v] + nnoblesesp[n];
                ps3she = "she " + "doesn't " + vnb[v] + nnobles[n]+prep.peoplespecialeng[p][p2];

                ps3eso = prep.peoplespecial[p][p2] + "no "+ vnb[v] + nnoblesesp[n];
    ...
    public void intporpasiva0a100(){
        ...
        switch (neg) {
            case 0:
                ...
                ps3 = "se " + vnb[v] + nnoblesesp[n]+ prep.peoplespecial[p][p2];
                ps3eng = "he " + vnb3[v] + nnobles[n]+ prep.peoplespecialeng[p][p2];
                ps3she = "she " + vnb3[v] + nnobles[n]+ prep.peoplespecialeng[p][p2];
                ps3it = "it " + vnb3[v] + nnobles[n]+ prep.peoplespecialeng[p][p2];
                ps4eng = "they " + vnb[v] + nnobles[n]+ prep.peoplespecialeng[p][p2];
